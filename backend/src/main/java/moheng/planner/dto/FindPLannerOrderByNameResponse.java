...
public class FindPLannerOrderByNameResponse {
    private List<TripScheduleResponse> tripScheduleResponses;

    private FindPLannerOrderByNameResponse() {
    }

    public FindPLannerOrderByNameResponse(final List<TripSchedule> tripSchedules) {
