...
include::{snippets}/live/info/member/update/http-request.adoc[]

===== Request Header

include::{snippets}/live/info/member/update/request-headers.adoc[]

===== Request Body

include::{snippets}/live/info/member/update/request-fields.adoc[]

==== HTTP Response

include::{snippets}/live/info/member/update/http-response.adoc[]

===== Response Body

include::{snippets}/live/info/member/update/response-body.adoc[]
