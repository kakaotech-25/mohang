...
=== 플래너 범위 탐색 조회 (날짜순) API

==== HTTP Request

include::{snippets}/planner/find/range/date/success/http-request.adoc[]

===== Request Header

include::{snippets}/planner/find/range/date/success/request-headers.adoc[]

===== Request Body

include::{snippets}/planner/find/range/date/success/request-fields.adoc[]

==== HTTP Response

include::{snippets}/planner/find/range/date/success/http-response.adoc[]

===== Response Body

include::{snippets}/planner/find/range/date/success/response-fields.adoc[]


=== 플래너 범위 탐색 조회 (날짜순) API 실패 (존재하지 않는 회원)

==== HTTP Request

include::{snippets}/planner/find/range/date/fail/http-request.adoc[]

===== Request Header

include::{snippets}/planner/find/range/date/fail/request-headers.adoc[]

===== Request Body

include::{snippets}/planner/find/range/date/fail/request-fields.adoc[]

==== HTTP Response

include::{snippets}/planner/find/range/date/fail/http-response.adoc[]

===== Response Body

include::{snippets}/planner/find/range/date/fail/response-body.adoc[]